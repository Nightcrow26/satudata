{{-- resources/views/livewire/public/agencies/show.blade.php --}}
@php
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-14" wire:init="load">
    ...
    <div class="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
        {{-- LEFT: ringkasan instansi (sticky di desktop) --}}
        <div class="md:col-span-3">
            <x-public.agencies.sidebar-card class="md:sticky md:top-24" 
                :name="$skpd->nama"
                :logo="$skpd->foto_url"
