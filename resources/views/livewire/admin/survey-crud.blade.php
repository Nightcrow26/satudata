<div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
    <!-- Total Surveys Card -->
    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800 shadow-sm">
      <div class="flex items-center">
        ...
        <div class="ml-4">
          <p class="text-sm font-medium text-blue-600 dark:text-blue-400">Total Survey</p>
          <p class="text-2xl font-bold text-blue-900 dark:text-blue-100">{{ number_format($totalSurveys) }}</p>
        </div>
      </div>
    </div>

    <!-- Average Rating Card -->
    <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-6 border border-green-200 dark:border-green-800 shadow-sm">
      <div class="flex items-center">
        <div class="flex-shrink-0">
        ...
        <div class="ml-4">
          <p class="text-sm font-medium text-green-600 dark:text-green-400">Rata-rata Rating</p>
