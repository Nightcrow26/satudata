    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div x-data="{
            ...
            <div x-ref="track" @scroll.debounce.120ms="update()" id="latest-track" class="flex gap-4 sm:gap-6 overflow-x-auto overflow-y-visible scroll-smooth
                ...
                $aspekWarna = ($i->aspek && $i->aspek->warna) ? $i->aspek->warna : '#0d9488'; // Default teal-600
                $aspekNama = ($i->aspek && $i->aspek->nama) ? $i->aspek->nama : 'Unclassified';
                ...
                <article class="relative snap-always shrink-0 transition-colors duration-200
                    ...
                    <a href="{{ route('public.walidata.show', $i->slug) }}" class="group block p-4" wire:navigate>
                        {{-- ROW atas --}}
