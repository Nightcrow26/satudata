...
'dataValue' => null, // nilai data
'dataUnit' => null, // satuan data
'year' => null, // tahun data
...
<article
    class="group relative w-full rounded-2xl border border-gray-200 dark:!border-gray-700 bg-white dark:!bg-gray-800 shadow-sm dark:!shadow-gray-900/20 hover:bg-gray-50 dark:hover:!bg-gray-700 hover:shadow-md dark:hover:!shadow-gray-900/30 transition-all duration-200 focus-within:outline-none focus-within:ring-2 focus-within:ring-teal-600 dark:focus-within:!ring-teal-400 focus-within:ring-offset-2 focus-within:ring-offset-white dark:focus-within:!ring-offset-gray-900">
    ...
    <div class="p-4 sm:p-5 flex gap-4 sm:gap-5">
        ...
        <div
            ...
            <div class="h-full w-full grid place-content-center text-gray-300 dark:text-gray-400">
                <svg class="h-8 w-8" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path
                        d="M3 3a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 13.846 4.632 16 6.414 16H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 6H6.28l-.31-1.243A1 1 0 005 4H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" />
                </svg>
            </div>
            @endif
        </div>
        ...
        <div class="min-w-0 flex-1">
            <h3 class="mb-0 text-base sm:text-lg font-semibold leading-none text-gray-900 dark:text-white line-clamp-1">
            ...
            <div class="mt-0 flex flex-wrap gap-2">
                ...
                @if($customStyle)
                <span class="inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ring-1 ring-inset ring-gray-500/10 dark:ring-gray-400/20 transition-colors duration-200"
                      data-custom-badge
                ...
                @else
                <span class="inline-flex items-center rounded-full px-2 py-1 text-xs font-medium ring-1 ring-inset ring-gray-500/10 dark:ring-gray-400/20 {{ $variant }}">
                    {{ $b['label'] }}
                </span>
                @endif
                @endforeach
