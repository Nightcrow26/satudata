{{-- resources/views/components/public/data/detail-sidepanel.blade.php --}}
@props([
/**
* dataset.agency.name : string
* dataset.agency.logo : url/path (opsional)
* dataset.meta : array of ['label' => '...', 'value' => '...']
*/
'dataset' => null,
