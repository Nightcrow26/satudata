{{-- resources/views/components/public/data/filter-panel.blade.php --}}
@props([
// Opsi
'sortOptions' => ['recent' => 'Terbaru', 'oldest' => 'Terlama'],
'aspekOptions' => [], // ['tek'=>'Teknologi', ...]
'instansiOptions' => [], // ['dinkes'=>'Dinas Kesehatan', ...]
'bidangOptions' => [], // ['sekda'=>'Sekretariat Daerah', ...]
...
<aside {{ $attributes->merge([
    ...
    <fieldset>
        ...
        $aspekSelected = collect(data_get($selected, 'aspek', []))->filter()->values()->all();
        @endphp
